...
{
    if (!_frontBtn) {
        _frontBtn = [[UIButton alloc] initWithFrame:CGRectMake(kWidth-64, 0, 64, 64)];
...
{
    if (!_flashBtn) {
        _flashBtn = [[UIButton alloc] initWithFrame:CGRectMake((kWidth-200)/2, 0, 50, 64)];
...
{
    if (!_flashView) {
        _flashView = [[UIView alloc] initWithFrame:CGRectMake(self.flashBtn.right-10, 0, 150, 64)];
        _flashView.backgroundColor = [UIColor clearColor];
        
        for (NSInteger i = 0; i < 3; i ++) {
            UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(50*i, 0, 50, 64)];
            btn.tag = 100+(2-i);
...
{
    if (!_timeLabel) {
        _timeLabel = [[UILabel alloc] initWithFrame:CGRectMake((kWidth-85)/2, 0, 80, 64)];
