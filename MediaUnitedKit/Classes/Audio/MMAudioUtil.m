...
@interface MMAudioUtil ()<AVAudioRecorderDelegate,AVAudioRecorderDelegate,AVAudioPlayerDelegate>
{
...
@implementation MMAudioUtil

#pragma mark - >>>单例

static MMAudioUtil *audioUtil = nil;
+ (instancetype)instance
{
    if (!audioUtil) {
        audioUtil = [[MMAudioUtil alloc] init];
    }
    return audioUtil;
}
...
- (NSString *)audioToMP3:(NSString *)cafPath
{
    ...
    @catch (NSException *exception) {
        DLog(@"音频转码异常：%@",[exception description]);
    }
    @finally {
